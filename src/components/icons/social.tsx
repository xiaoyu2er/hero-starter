...
const ChevronDownIcon: React.FC<IconSvgProps> = ({
  fill,
  size,
  width,
  height,
...
const LockIcon: React.FC<IconSvgProps> = ({
  fill: color,
  size,
  width,
  height,
...
const ActivityIcon: React.FC<IconSvgProps> = ({
  fill,
  size,
  width,
  height,
...
const FlashIcon: React.FC<IconSvgProps> = ({
  fill = 'currentColor',
  size,
  width,
  height,
...
const ServerIcon: React.FC<IconSvgProps> = ({
  fill = 'currentColor',
  size,
  width,
  height,
...
const TagUserIcon: React.FC<IconSvgProps> = ({
  fill = 'currentColor',
  size,
  width,
  height,
...
const ScaleIcon: React.FC<IconSvgProps> = ({
  fill = 'currentColor',
  size,
  width,
  height,
