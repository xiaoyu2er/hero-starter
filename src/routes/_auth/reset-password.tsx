import { Button, Form, Image, addToast } from '@heroui/react';
  ...
  if (error || !token) {
    return (
      <div className="flex w-full max-w-sm flex-col items-center gap-4 rounded-large bg-content1 p-6 pb-10 shadow-small">
        ...
        <h1 className="font-medium text-lg sm:text-xl">Invalid reset link</h1>
        ...
        <div className="flex w-full gap-2">
          ...
          <Button className="flex-1" color="primary" as={Link} to="/login">
            Back to Login
          </Button>
        </div>
      </div>
